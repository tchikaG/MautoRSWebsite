...
<body>
    ...
    <link href="pay.php" class="fa fa-shopping-basket float-right" style="font-size: 78px;margin-top: 90px;margin-right: 90px;margin-bottom: 50px;margin-left: 30px;"></link>
        ...
        <?php foreach ($resultat as $shop): ?>
            <div class="col-md-6 col-lg-4">
                <div class="pricingTable" style="padding-bottom: 0px;">
                    <div class="pricingTable-header"><span class="icon"><img src="" style="width: 134px;height: 133px;margin-top: -80px;"></span>
                    ...
                    <div class="pricing-content">
                        ...
                        </ul><a class="pricingTable-signup" style="background-color: rgb(84,149,247);" href="#">Ajouter</a></div>
                </div>
            </div>
            <?php endforeach; ?>
            </div>
