...
<body style="background-image: url(&quot;assets/img/star-sky.jpg&quot;);">
    <div>
        <div class="container-fluid">
            <h1 style="margin-top: 201px;padding-bottom: 0px;color: rgb(255,255,255);">Contact</h1>
            <hr>
            <form id="contactForm" action="javascript:void(0);" method="get"><input class="form-control" type="hidden" name="Introduction" value="This email was sent from www.awebsite.com"><input class="form-control" type="hidden" name="subject" value="Awebsite.com Contact Form"><input class="form-control" type="hidden"
                ...
                <div class="form-row" style="height: 800px;">
                    <div class="col-12 col-md-6" id="message" style="height: 600px;margin-right: 25%;margin-left: 25%;background-color: rgba(54,54,54,0.48);">
                        <h2 class="h4" style="color: rgb(255,255,255);"><i class="fa fa-envelope"></i> Contact Us<small><small class="required-input" style="color: rgb(211,0,0);">&nbsp;(*required)</small></small>
                        </h2>
                        <div class="form-group"><label for="from-name" style="color: rgb(255,255,255);">Name</label><span class="required-input" style="color: rgb(211,0,0);">*</span>
                        ...
                        <div class="form-group"><label for="from-email" style="color: rgb(255,255,255);">Email</label><span class="required-input" style="color: rgb(211,0,0);">*</span>
                            <div class="input-group">
                        ...
                        <div class="form-row">
                            <div class="col-12 col-sm-6 col-md-12 col-lg-6">
                                <div class="form-group"><label for="from-phone" style="color: rgb(255,255,255);">Phone</label><span class="required-input" style="color: rgb(211,0,0);">*</span>
                                    <div class="input-group">
                            ...
                            <div class="col-12 col-sm-6 col-md-12 col-lg-6">
                                <div class="form-group"><label for="from-calltime" style="color: rgb(255,255,255);">Best Time to Call</label>
                                    <div class="input-group">
                        ...
                        <div class="form-group"><label for="from-comments" style="color: rgb(255,255,255);">Comments</label><textarea class="form-control" id="from-comments" name="comments" placeholder="Enter Comments" rows="5"></textarea></div>
