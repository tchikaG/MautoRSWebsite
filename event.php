                ...
                <div class="col-md-12" style="padding-top: 20px;padding-bottom: 20px;">
                    <div style="background-color: #ffffff;">
                        ...
                        $db = mysqli_connect($db_host, $db_username, $db_password,$db_name)
                            ...
                            $ligne = $exec_requete->fetch_assoc();
                            if($ligne['id_utilisateur'] == '1'){
                                echo "<form><a href='edit_event.php?id_e=".$event['id_event']."' class='btn btn-primary'  style='margin-left: 1006px;background-color: rgba(93,130,169,0.83);font-size: 15px;'>Edit</a></form><br>";
                                echo "<form><a href='delete_event.php?id_e=".$event['id_event']."' class='btn btn-primary'  style='margin-left: 1006px;background-color: rgba(93,130,169,0.83);font-size: 15px;'>Delete</a></form>";                                                        
                            }
                            else
                            {
                            }
